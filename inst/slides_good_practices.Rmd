...
Suppose you have a dataset of sales transactions, and you want to calculate the total sales, the total number of transactions, and the average sales amount for each day. `r emo::ji("man_office_worker")` `r emo::ji("woman_office_worker")`
...
- **Indentation:** Always use consistent indentation to improve code readability.

- **Spacing:** Treat spaces in your code like breaths in a conversation - place them around operators, after commas, and between function arguments to give your code room to speak clearly, ensuring its story is easily understood by anyone who reads it.

- **Line limits:** Shorter lines are easier to read and understand, as they require less horizontal scanning by the reader. Long lines can be difficult to follow, increasing the cognitive load and the risk of misinterpretation. 80 character lines are recommended.
