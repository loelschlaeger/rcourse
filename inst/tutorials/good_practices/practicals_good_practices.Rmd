...
## Part 2: Functions and exceptions
...
Now you will program your own functions. The following R code calculates the area of three rectangles. Improve the code to use a function that calculates the area of a rectangle given its length and width.
