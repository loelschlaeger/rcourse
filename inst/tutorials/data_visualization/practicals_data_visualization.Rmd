...
description: >
  The practical part of the data visualization R course.
---

```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = FALSE)
library("rcourse")
packages_required <- c("dplyr", "ggplot2", "maps", "learnr", "pillar", "socviz", "gapminder")
...
quiz(
  ...
  question("Which of the following geoms requires a specification of the `y` mapping?",
...
ggplot(data = us_states_elec, aes(x = long, y = lat, group = group, fill = party)) +
  geom_polygon(color = "grey", linewidth = 0.1) +
  coord_map(projection = "albers", lat0 = 39, lat1 = 45)
```
...
Instead of plotting the winner, we can plot the percentage of the vote received by Trump from the `pct_trump` variable. Use `scale_fill_gradient(low = "white", high = "red")` as an alternative color gradient.
