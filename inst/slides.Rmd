...
```{r, echo=FALSE}
p <- ggplot(filter(gapminder, year==2007), aes(x = gdpPercap, y=lifeExp, size = pop, colour = continent,
...
Hint 1:
Use your {dplyr}-knowledge to create an extract of the gapminder dataset that only contains values from the year 2007.
